...
const companies = [
  ...
  {
    name: "ElevenLabs",
    logo: "/member-work-logos/elevenlabs.svg",
    width: 140,
    height: 18,
  },
  {
    ...
    <main className="relative min-h-screen overflow-x-hidden bg-splash-dark pb-32">
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        <div className="relative">
          ...
          <div className="mx-auto my-20 lg:my-32 max-w-[480px] sm:max-w-[832px] lg:max-w-[960px] animate-[bob_12s_ease-in-out_infinite] relative z-10">
            ...
            <div className="max-w-[420px] sm:max-w-full pt-7 leading-snug text-2xl md:text-[28px] md:pl-3.5">
              <p>
                Job applications are dead. Get a warm referral to your
                ideal&nbsp;startup.
              </p>
            </div>
          </div>
        ...
        <div className="md:grid md:grid-cols-2 pb-4 mt-20">
          ...
          <div className="md:border-l border-white/20 md:pl-8 xl:px-12 2xl:px-16 pb-4 md:pb-10 lg:pb-3 md:self-center">
            <div className="mx-auto mb-10 md:mb-16 w-full sm:pr-0 lg:pr-6 lg:text-left">
              <h2 className="border-t border-white/20 md:border-none text-[80px] font-bold leading-none pt-16 md:pt-4 lg:pt-0">
                Learn more.
              </h2>
            </div>
            <a
